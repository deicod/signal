...
func TestResponderDerivesSameSecretWithAndWithoutPreKey(t *testing.T) {
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			require.NotNil(t, initResult.PQRKey)
			require.NotNil(t, respResult.PQRKey)
			require.Equal(t, *initResult.PQRKey, *respResult.PQRKey)
...
func TestResponderSharedSecretMatchesManualDH(t *testing.T) {
	...
	require.NotNil(t, respResult.PQRKey)
	require.Equal(t, expectedPQR, *respResult.PQRKey)
